// $ANTLR 3.3 Nov 30, 2010 12:50:56 Expr.g 2017-04-07 08:28:35
...
public class ExprLexer extends Lexer {
    ...
    public final void mID_CLASS() throws RecognitionException {
        try {
            int _type = ID_CLASS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Expr.g:150:10: ( 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // Expr.g:150:12: 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
            matchRange('A','Z'); 
            // Expr.g:150:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mID_OTHERS() throws RecognitionException {
        try {
            int _type = ID_OTHERS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Expr.g:151:11: ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // Expr.g:151:13: 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
            matchRange('a','z'); 
            // Expr.g:151:22: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            loop5:
            do {
                int alt5=2;
