// $ANTLR 3.2 Sep 23, 2009 12:02:23 /home/clement/workspace/Compil_MACA/Fichiers/Expr.g 2017-04-05 18:40:12
...
public class ExprLexer extends Lexer {
    ...
    public final void mINT() throws RecognitionException {
        try {
            int _type = INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:142:5: ( ( '0' .. '9' )+ )
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:142:7: ( '0' .. '9' )+
            {
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:142:7: ( '0' .. '9' )+
            int cnt1=0;
            loop1:
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            int _type = STRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:143:8: ( '\"' ( ' ' .. '!' | '#' .. '~' )* '\"' )
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:143:12: '\"' ( ' ' .. '!' | '#' .. '~' )* '\"'
            {
            match('\"'); 
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:143:16: ( ' ' .. '!' | '#' .. '~' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mOPERCONDITION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:145:14: ( '<' | '<=' | '>' | '>=' | '==' | '!=' )
            int alt3=6;
            switch ( input.LA(1) ) {
            case '<':
                {
            ...
            switch (alt3) {
                case 1 :
                    // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:145:15: '<'
                    {
                    match('<'); 
                    ...
                    break;
                case 2 :
                    // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:145:19: '<='
                    {
                    match("<="); 
                    ...
                    break;
                case 3 :
                    // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:145:24: '>'
                    {
                    match('>'); 
                    ...
                    break;
                case 4 :
                    // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:145:28: '>='
                    {
                    match(">="); 
                    ...
                    break;
                case 5 :
                    // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:145:33: '=='
                    {
                    match("=="); 
                    ...
                    break;
                case 6 :
                    // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:145:38: '!='
                    {
                    match("!="); 
    ...
    public final void mID_CLASS() throws RecognitionException {
        try {
            int _type = ID_CLASS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:148:10: ( 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:148:12: 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
            matchRange('A','Z'); 
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:148:21: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mID_OTHERS() throws RecognitionException {
        try {
            int _type = ID_OTHERS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:149:11: ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:149:13: 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
            matchRange('a','z'); 
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:149:22: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mCOMMENTS() throws RecognitionException {
        try {
            int _type = COMMENTS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:151:10: ( '/*' ( . )* '*/' )
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:151:12: '/*' ( . )* '*/'
            {
            match("/*"); 

            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:151:17: ( . )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mNEWLINE() throws RecognitionException {
        try {
            int _type = NEWLINE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:152:8: ( ( '\\r' )? '\\n' )
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:152:9: ( '\\r' )? '\\n'
            {
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:152:9: ( '\\r' )?
            int alt7=2;
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:153:4: ( ( ' ' | '\\t' )+ )
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:153:6: ( ' ' | '\\t' )+
            {
            // /home/clement/workspace/Compil_MACA/Fichiers/Expr.g:153:6: ( ' ' | '\\t' )+
            int cnt8=0;
            loop8:
